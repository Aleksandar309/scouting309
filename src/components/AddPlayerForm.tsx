...
import { CalendarIcon, PlusCircle, Trash2, /* Foot */ } from "lucide-react"; // Removed Foot icon
...
const AddPlayerForm: React.FC<AddPlayerFormProps> = ({ onAddPlayer, onClose }) => {
  const form = useForm<AddPlayerFormValues>({
    ...
    defaultValues: {
      ...
      value: "€1M",
      footed: "Right Footed",
      // leftFootRating: 7, // Removed default
      // rightFootRating: 7, // Removed default
      avatarUrl: "",
      details: {
        height: "180 cm",
        weight: "75 kg",
