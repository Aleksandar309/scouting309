...
const ShadowPitch: React.FC<ShadowPitchProps> = ({
  ...
  const [pitchDimensions, setPitchDimensions] = useState<{ width: number; height: number } | null>(null); // Initialize as null
  ...
  // Only render draggable players if pitch dimensions are available
  if (pitchDimensions) {
