...
export const ALL_ATTRIBUTE_NAMES = [
  ...
  "Heading", // Promenjeno iz "Aerial Ability"
  "Tackling", "Finishing", "Technique",
  // Tactical
  "Positioning", "Decision Making", "Game Intelligence", "Off-Ball Movement",
  "Pressing", "Defensive Awareness", "Vision", "Anticipation", "Marking",
  // Physical
  "Pace", "Acceleration", "Strength", "Jumping Reach", "Stamina", "Agility", "Recovery", "Balance", "Natural Fitness", // Dodato "Jumping Reach"
  // Mental & Psychology
...
export const CATEGORIZED_ATTRIBUTES: { [key: string]: string[] } = {
  technical: ["First Touch", "Passing Range", "Ball Striking", "Dribbling", "Crossing", "Heading", "Tackling", "Finishing", "Technique"], // Promenjeno iz "Aerial Ability"
  ...
  physical: ["Pace", "Acceleration", "Strength", "Jumping Reach", "Stamina", "Agility", "Recovery", "Balance", "Natural Fitness"], // Dodato "Jumping Reach"
